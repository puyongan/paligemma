...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
        ...
        # output of conv have shape [Batch_Size, Embed_Dim, Num_Patches_H, Num_Patches_W]
...
class SiglipAttention(nn.Module):
    ...
    def forward(
            ...
            # Calculate using: Q * K^T / sqrt(d_k). atten_weights: [Batch_Size, Num_Heads, Num_Patches, Num_Patches]
...
class SiglipVisionTransformer(nn.Module):
    ...
    def forward(self, pixels_values: torch.Tensor) -> torch.Tensor:
        # pixel_values: [Batch_Size, Channels, Height, Width] -> [Batch_Size, Num_Patches, Embed_Dim]
        hidden_states = self.embeddings(pixels_values)
